...
double vecteur::prod_scal(vecteur *v) // la definition de fonction prod_scal par adresse
{
    return (x * v->x + y * v->y + z * v->z);
}
vecteur vecteur::somme(vecteur *v) // la definition de fonction somme par adresse
{
    vecteur res;
    res.x = x + v->x;
    res.y = y + v->y;
